...
function onCreate()
	makeLuaSprite('UpperBar', 'empty', 0, -240 - 50)
...
--[[	makeLuaSprite('ppp', 'empty', 0, getPropertyFromClass('lime.app.Application', 'current.window.y'))
	...
	makeLuaSprite('LowerBar', 'empty', 0, 600 + 50)
...
function onBeatHit()
	if curBeat == 1 then
	doTweenY('Cinematics11', 'UpperBar', -240 - 50, 7, 'circOut')
	doTweenY('Cinematics21', 'LowerBar', 600 + 50, 7, 'circOut')
end
end